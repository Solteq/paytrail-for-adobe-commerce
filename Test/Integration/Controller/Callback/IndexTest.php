...
namespace Paytrail\PaymentService\Test\Integration\Controller\Callback;
...
class IndexTest extends \Magento\TestFramework\TestCase\AbstractController
{
     ...
     */
    public function testCallback($responses, $expected)
    {
        $okIndex = 999;
        foreach ($responses as $index => $response) {
            ...
            // TODO check order status matches expected values
            /** @var Order $order */
